...
export default function TermsOfServicePage() {
  const brandConfig = brands.gameon; // ✅ Hardcode GameOn
    ...
    >
      <div className="w-full max-w-4xl mx-auto px-6 py-12 text-white">
        ...
        <p className="mb-6 text-lg">
          By using {brandConfig.companyName}, you agree to abide by these Terms of Service. 
          These terms govern your access to and use of the {brandConfig.companyName} platform.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2 text-lg">
          <li>
            {brandConfig.companyName} coaches may offer sessions in a wide variety of games,
            including titles not officially supported by the platform. Sessions involving
            prohibited content, ESRB Adults Only (AO) ratings, or games banned by streaming
            platforms may not be recorded or monetized, and may be blocked from certain
            platform features. {brandConfig.companyName} is not liable for session content
            related to unsupported or restricted games. It is the responsibility of the player
            and coach to ensure the session complies with local laws, platform rules, and Community Guidelines.
          </li>
        </ul>
